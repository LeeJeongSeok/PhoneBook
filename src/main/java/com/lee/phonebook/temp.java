...
public class temp {
    ...
    public void result_menu2(int code) {
        if (MODE == 1 && code == 10) {
            ...
            MODE += 1;
        } else if (MODE == 3 && code == 10) {
            temp += inputTextField.getText() + ",";
            resultArea.append(inputTextField.getText() + "\n");
            inputTextField.setText("");
            resultArea.append("부서를 입력해주세요.\n");
            MODE += 1;
        } else if (MODE == 4 && code == 10) {
            temp += inputTextField.getText() + ",";
            resultArea.append(inputTextField.getText() + "\n");
            inputTextField.setText("");
            resultArea.append("번호를 입력해주세요.\n");
            MODE += 1;
        } else if (MODE == 5 && code == 10) {
            temp += inputTextField.getText();
            resultArea.append(inputTextField.getText() + "\n");
            inputTextField.setText("");
            resultArea.append("한번더 엔터 누르면 입력완료 \n");
            MODE += 1;
        } else if (MODE == 6 && code == 10) {
            writeHashMap();
        }
    }

    public void result_menu3(int code) {
        if (MODE == 1 && code == 10) {
            inputTextField.setText("");
    ...
    public void result_menu4(int code) {
        if (MODE == 1 && code == 10) {
            inputTextField.setText("");
